/**
 * @file Handles the rendering and interactivity of the game board.
 * @description Responsible for drawing the board on the UI and listening to user interactions.
 * 
 * TODO:
